...
export const Dropdown: Component<{
  ...
  return (
    ...
    >
      ...
      <Portal>
        <Select.Positioner>
          <Select.Content class="z-40 max-h-[calc(var(--available-height)_-_32px)] w-full overflow-y-auto rounded-md border bg-white shadow-lg outline-none dark:bg-gray-900">
